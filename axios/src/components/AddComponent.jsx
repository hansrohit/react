...
import { postProjectData } from "../services/api";
...
const AddComponent = () => {
  ...
  const handleAdd = async (e) => {
    ...
    try {
      const response = await postProjectData(projectdata);
  ...
  return (
    <>
      <button
        ...
        className="flex justify-center items-center text-white bg-purple-500 px-2 py-1 rounded-sm"
      >
        Add
              ...
              <div className="w-full h-[85%] flex flex-row justify-center items-center">
                ...
                >
                  <input
                    ...
                    id="title"
                    placeholder="Title"
                    className="p-3 bg-[#f8f8f8] w-full font-bold outline-none active:outline-none focus:border-b-2 hover:border-b-2 hover:border-purple-200  focus:border-purple-600"
                    required
                  />
                  <input
                    type="text"
                    ...
                    id="desc"
                    placeholder="Desc"
                    className="p-3 bg-[#f8f8f8] w-full font-bold outline-none active:outline-none focus:border-b-2  hover:border-b-2 hover:border-purple-200 focus:border-purple-600 mb-3"
                    required
                  />
                  <input
                    type="text"
                  ...
                  <button
                    type="submit"
                    className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-sm text-md px-5 py-2.5 text-center w-full h-[15%] mt-4"
                  >
                    Add Project
                  </button>
                </form>
